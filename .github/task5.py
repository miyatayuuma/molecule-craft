...
# Same-schema optional CHO state is tolerated by current persistence and becomes
# canonical on the next completion. Non-current schemas are intentionally reset to
# the current baseline; Molecule DB v2 no longer promises legacy/future save replay.
replace('tests/cho-campaign.test.mjs',
