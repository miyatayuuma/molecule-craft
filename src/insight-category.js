...
export const INSIGHT_CATEGORIES=Object.freeze(['propellant','fuel','oxidizer','coolant','general']);
export const INSIGHT_CATEGORY_COLORS=Object.freeze({propellant:'#5ee7ff',fuel:'#ffb454',oxidizer:'#ff6f73',coolant:'#8fb9ff',general:'#c6d0d8'});
