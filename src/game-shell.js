...
export function createGameShell({canOpen=()=>true}={}){
  ...
  for(const [button,id]of [['open-menu','menu-dialog'],['open-info','info-dialog'],['menu-info','info-dialog']])q(button)?.addEventListener('click',()=>open(id));
