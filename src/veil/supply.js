...
export function createSupplyUI({resources,canOpen,canMake,onCommit,onRequestLaunch=()=>false,onLaunchReady=()=>false}){
  ...
  function renderComparison(record){
    ...
    renderLoadoutPreview(host,{use:selectedUse,candidateId:record.id,currentId:tank.molecule,currentAmount:tank.amount,candidateAmount,oxygenAmount,coolantId,reduced,oxygenTankCapacity});
  }
