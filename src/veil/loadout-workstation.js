...
function addUnitImages(map){if(!map)return;for(const [kind,url] of [['pulse',PULSE_UNIT_URL],['drive',DRIVE_UNIT_URL]]){if(map.querySelector(`.loadout-${kind}-image`))continue;const img=document.createElement('img');img.className=`loadout-unit-image loadout-${kind}-image`;img.src=url;img.alt='';img.draggable=false;img.setAttribute('aria-hidden','true');map.append(img);}}
...
#supply-dialog .port-propellant{left:2.5%!important;right:auto!important;top:50%!important;bottom:auto!important;width:25%!important;height:74px!important;transform:translateY(-50%);padding:0!important}
...
#supply-dialog .collector-shell-map:has(#expedition-destinations[aria-hidden='false']) .loadout-unit-image,#supply-dialog .collector-shell-map:has(#expedition-destinations[aria-hidden='false']) .loadout-drive-label{opacity:.34}
...
@media(max-width:370px){#supply-dialog .collector-shell-map{height:178px!important}#supply-dialog #collector-launch-handle{width:70px!important;height:70px!important}#supply-dialog .loadout-pulse-image,#supply-dialog .port-propellant{width:24%!important;height:68px!important}#supply-dialog .port-fuel,#supply-dialog .port-oxidizer,#supply-dialog .port-coolant{height:62px!important}#supply-dialog .shell-port>span{font-size:6px}#supply-dialog .shell-port>small{font-size:9px}#supply-dialog .loadout-drive-label{top:13px;font-size:8px}#supply-dialog .tank-comparison .loadout-stat,#supply-dialog .loadout-charges{grid-template-columns:55px 1fr}}
@media(prefers-reduced-motion:reduce){#supply-dialog .shell-port,#supply-dialog .loadout-unit-image{transition:none}}
