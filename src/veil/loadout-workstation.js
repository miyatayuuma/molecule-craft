...
#supply-dialog .loadout-molecule-pod{position:absolute;z-index:0;left:50%;top:0;width:56px;height:54px;transform:translate(-50%,-58%);display:grid;place-items:center;padding:0;box-sizing:border-box;border:0;border-radius:0;background:none;box-shadow:none;pointer-events:none;user-select:none}
#supply-dialog .loadout-molecule-thumb{width:56px;height:54px;object-fit:contain;pointer-events:none;user-select:none;filter:drop-shadow(0 1px 3px #000b) drop-shadow(0 0 5px #9ce9f044)}
...
#supply-dialog .port-propellant>.loadout-molecule-pod{width:70px;height:62px;top:0;transform:translate(-50%,-58%)}
#supply-dialog .port-propellant .loadout-molecule-thumb{width:70px;height:62px}
