...
export function createResources({storage,onStatus=()=>{}}={}){
  ...
  const api={
    ...
    setFrontierGraph(graph){frontierGraph=graph??null;return !!frontierGraph;},frontierInsightDiagnostics:()=>copy(frontierRun??lastFrontierRun??{selectedCandidateId:null,launchRegion:null,weightingRegion:null,opportunityCreated:false,acquired:false,carried:false,committed:false,lost:false,reason:'no-run'}),
    reset(categories){
