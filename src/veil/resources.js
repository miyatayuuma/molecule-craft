...
const initialState=()=>({schemaVersion:3,elements:{H:0,C:0,O:0},molecules:{hydrogen:0,methane:0,oxygen:0,water:0},tanks:initialTanks(),recipes:[],hints:[],dust:{H:0,C:0,O:0},loadout:{drive:'hydrogen',cooling:true},progress:initialProgress(),workspace:null});
...
function migrate(old){
  ...
  const next={...initialState(),...old,schemaVersion:3};next.elements={H:0,C:0,O:0,...old.elements};next.molecules={hydrogen:0,methane:0,oxygen:0,water:0,...old.molecules};next.tanks=initialTanks();next.progress={...initialProgress(),...old.progress};
