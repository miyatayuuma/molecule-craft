...
console.log('Loadout auto-synthesis supply passed: atomic capability assignment, overwrite protection, tank/content separation, rollback, free selection, residual reuse, replacement discard, empty tanks, proportional partial fill, impossible guard, and stale-save reset.');
