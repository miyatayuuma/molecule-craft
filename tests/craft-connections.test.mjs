...
import {commitEmptyLaunchFill,createDiscoveryConnection,normalizeLaunchFillPlan,preserveSupplyDuringPrepare} from '../src/craft-connections.js?v=1';
...
console.log('Craft connections passed: empty-tank launch fallback, LOADOUT-preserving launch preparation, discovery propagation, deduplication, dismissal and restored-workspace suppression.');
