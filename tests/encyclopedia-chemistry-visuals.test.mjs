...
assert.equal(records.length,142,'Chemistry visual grammar must not change the 142-molecule production catalog');
...
console.log('Encyclopedia chemistry visual grammar passed: aromaticity derives from concepts; resonance/formal-charge/polarity are curated and schema-validated across 142 molecules.');
