...
try{
  ...
  const clCarry=await evaluate(`(()=>({cargo:globalThis.__nitrogenChapterRun.rareCargo.Cl,hud:document.querySelector('#veil-minerals')?.textContent??''}))()`);assert.equal(clCarry.cargo,1);assert.match(clCarry.hud,/RARE Cl 1/);
