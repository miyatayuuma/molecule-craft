...
assert.match(graphViewSource,/updateGraphChevrons\(chevronEdges,null\);runGraphGeometryMotion\(graphMotion,geometryTweens,edgeTweens,chevronEdges/,'A safe Chevron must be initialized from the tween start edge before the first RAF, never hidden until motion starts');
