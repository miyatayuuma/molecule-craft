...
assert.match(graphViewSource,/motionNodeCircles=edgeProgress=>\{const extra=GRAPH_MOTION_CHEVRON_CLEARANCE\*\(1-clamp\(edgeProgress\?\?0,0,1\)\)/,'motion-time Chevron clearance must taper to zero as the shared edge tween reaches final geometry');
