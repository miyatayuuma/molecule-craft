...
assert.equal(RETURN_EFFECTS.stable.duration,EXPEDITION.normalExtractionSeconds);assert.deepEqual(RETURN_EFFECTS,{stable:{duration:.8},emergency:{duration:.65}});
