...
console.log(`PWA passed: ${entries.length} hashed assets, dependency closure, icons, 159 numbered entries/previews, HTTP-cache-safe online refresh with verified offline fallback, missing pages, explicit discovery/activation updates and multi-window blocking.`);
