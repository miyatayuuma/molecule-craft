...
console.log('Encyclopedia content browser validation passed: 11 representative molecules, mobile Summary → Chemistry Detail → selective collection note → Graph return, including structural-isomer navigation.');
